...
},{"react":177,"react/lib/Object.assign":33}],5:[function(require,module,exports){
...
},{"eventemitter3":178}],191:[function(require,module,exports){
...
},{"./ListenerMixin":191,"reflux-core/lib/ListenerMethods":181,"reflux-core/lib/utils":190}],193:[function(require,module,exports){
var ListenerMethods = require('reflux-core/lib/ListenerMethods'),
    ListenerMixin = require('./ListenerMixin'),
    _ = require('reflux-core/lib/utils');
...
},{"./ListenerMixin":191,"./connect":192,"./connectFilter":193,"./listenTo":195,"./listenToMany":196,"reflux-core":187}],195:[function(require,module,exports){
var ListenerMethods = require('reflux-core/lib/ListenerMethods');
...
},{"reflux-core/lib/ListenerMethods":181}],196:[function(require,module,exports){
var ListenerMethods = require('reflux-core/lib/ListenerMethods');
...
},{"reflux-core/lib/ListenerMethods":181}],197:[function(require,module,exports){
...
// Globals
var BUBBLEDIM = { width: 260, height: 120 }; // Make the marker land at the tip of the pointer. Not sure how this varies between browsers/OSes
...
},{"./Circle":198,"./Content":200,"./Highlight":201,"./Input":202,"./Marker":203,"./Square":205,"react/addons":5}],198:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
},{"classnames":2,"react/addons":5}],199:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
var Container = React.createClass({
  ...
  updateOffset: function updateOffset() {
    var offset = this.offset(React.findDOMNode(this));
  ...
  saveAnnotation: function saveAnnotation(content) {
  ...
  editAnnotation: function editAnnotation(id) {
  ...
  cancelAnnotation: function cancelAnnotation() {
    var _this = this;
    ...
    setTimeout(function () {
      _this.setState({ pendingAnnotation: null });
    }, 50);
  },

  displayAnnotationViewer: function displayAnnotationViewer(id) {
  ...
  hideAnnotationViewer: function hideAnnotationViewer(id) {
    var _this2 = this;
    ...
    this.viewerHideTimer = setTimeout(function () {
      ...
      if (_this2.props.onDeselect) {
        _this2.props.onDeselect();
      }
      _this2.setState({ visibleViewerId: 0 });
    }, 250);
  },
  ...
  render: function render() {
    ...
    if (!this.props.hidden) {
      annotations = sortedAnnotations.map(function (a, i) {
        var m = a.toJS();
        return React.createElement(Annotation, { key: m.id,
          id: m.id,
          priority: i + 1,
          content: m.content,
          timeStamp: m.timeStamp,
          pending: false,
          shouldDisplayViewer: m.id === _this3.state.visibleViewerId,
          deemphasize: _this3.state.visibleViewerId !== 0 && m.id !== _this3.state.visibleViewerId,
          displayAnnotationViewer: _this3.displayAnnotationViewer,
          hideAnnotationViewer: _this3.hideAnnotationViewer,
          deleteAnnotation: _this3.deleteAnnotation,
          editAnnotation: _this3.editAnnotation,
          type: m.type,
          author: m.author,
          containerOffset: _this3.state.containerOffset,
          x1: m.x1 * _this3.props.scale,
          y1: m.y1 * _this3.props.scale,
          x2: m.x2 * _this3.props.scale,
          y2: m.y2 * _this3.props.scale });
      });
    }

    return React.createElement(
      'div',
      { ref: 'cdContainer', className: 'cd-container',
        onClick: this.handleClick,
        onMouseDown: this.handleMouseDown,
        onMouseUp: this.handleMouseUp,
        onMouseMove: this.handleMouseMove
      },
      React.createElement(ModeToggle, { mode: this.state.mode, switchMode: this.switchMode }),
      annotations,
...
},{"./Annotation":197,"./ModeToggle":204,"immutable":3,"react/addons":5}],200:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          this.props.author,
          ' ',
          React.createElement(Timeago, { date: this.props.timeStamp })
        )
      )
    );
  }
...
},{"./Input":202,"classnames":2,"react-timeago":4,"react/addons":5}],201:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
},{"classnames":2,"react/addons":5}],202:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
},{"classnames":2,"react/addons":5}],203:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
},{"classnames":2,"react/addons":5}],204:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
},{"react/addons":5}],205:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
},{"classnames":2,"react/addons":5}],206:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
var Demo = React.createClass({
  ...
  handleAnnotationSave: function handleAnnotationSave(annotation) {
    AnnotationActions.annotationSave(annotation);
  },

  handleAnnotationDelete: function handleAnnotationDelete(id) {
...
document.addEventListener('DOMContentLoaded', function () {
  React.render(React.createElement(Demo, null), document.getElementById('content'));
});

},{"../test/AnnotationActions.js":207,"../test/AnnotationStore.js":208,"./Container":199,"react/addons":5,"reflux":194}],207:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
},{"reflux":194}],208:[function(require,module,exports){
/* carbondream - Copyright 2015 Zeroarc Software, LLC
 *
...
},{"./AnnotationActions":207,"immutable":3,"reflux":194}]},{},[206])(206)
});